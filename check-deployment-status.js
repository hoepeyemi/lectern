...
async function checkDeploymentStatus() {
  try {
    ...
    console.log('💡 Explorer: https://blockscout-testnet.polkadot.io/address/' + account.address);
    console.log('');
    ...
    if (pendingNonce > confirmedNonce) {
      ...
      console.log('   2. Check explorer: https://blockscout-testnet.polkadot.io/address/' + account.address);
