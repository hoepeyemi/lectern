...
async function waitForPendingTransactions() {
  try {
    ...
    console.log('💡 Check transactions at: https://blockscout-testnet.polkadot.io/address/' + account.address);
    console.log('');
    ...
    if (hasPending) {
      ...
      console.log(`   https://blockscout-testnet.polkadot.io/address/${account.address}`);
    }
  } catch (error) {
