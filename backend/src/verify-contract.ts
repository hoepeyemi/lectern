...
// Lectern (ModredIP) contract ABI (simplified for IP registration)
const MODRED_IP_ABI = [
    {
        "inputs": [
            {
...
async function main() {
    ...
    const v2Address = '0x5829940874605d61496CE818914B972c507E55c7' as Address; // ModredIPModule#ModredIP

    const v1HasFunction = await verifyContract(v1Address, 'Lectern Module V1');
    const v2HasFunction = await verifyContract(v2Address, 'Lectern Module V2');
